...
void join_lld(t_main *main)
{
  ...
  if(main->accurate == -1)
    main->accurate = ft_strlen(my_itoa((long long int)main->elem));
  size = ft_strlen(my_itoa((long long int)main->elem));
  number = my_itoa((long long int)main->elem);
  if(main->accurate > size)
    number = ft_strsub(number, 0, main->accurate);
  main->size += ft_strlen(my_itoa((long long int)main->elem));
...
void join_lu(t_main *main)
{
  ...
  if(main->accurate == -1)
    main->accurate = ft_strlen(my_utoa((unsigned long long int)main->elem));
  size = ft_strlen(my_utoa((unsigned long long int)main->elem));
  number = my_utoa((unsigned long long int)main->elem);
  if(main->accurate > size)
    number = ft_strsub(number, 0, main->accurate);
  main->size += ft_strlen(my_utoa((unsigned long long int)main->elem));
  accurate_d(size, main);
  main->print = ft_strjoin(main->print, &number[0]);
}
